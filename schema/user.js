...
var userSchema = new mongoose.Schema({
    ...
    connections: [mongoose.Schema.Types.ObjectId], // IDs of the users to whom the user is connected
    drafts: [mongoose.Schema.Types.ObjectId] // IDs of the user's proposal drafts
});
